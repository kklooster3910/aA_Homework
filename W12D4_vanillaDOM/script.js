document.addEventListener("DOMContentLoaded", () => {
  ...
  // --- your code here!
  const favoriteInput = document.getElementById("favorite-form");
  favoriteInput.addEventListener("submit", event => {
    event.preventDefault();

    const faveInputName = document.getElementById("fave-name");    
    const faveName = faveInputName.value;
    faveInputName.value = "";

    const ul = document.getElementById("restaurants");
    const li = document.createElement("li");
    li.textContent = faveName;
